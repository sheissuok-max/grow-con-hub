      ...
      <section className="min-h-screen flex items-center justify-center py-24 px-4" style={{ background: "var(--gradient-section)" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-4 leading-relaxed">
            데이터 기반의 외식업 분석 서비스를 준비하고 있습니다.<br />
            감이 아닌 데이터로 경영하는 시대를 함께 열어갑니다.
          </p>
          ...
          <div className="bg-card rounded-2xl border border-border p-8 text-left shadow-card-custom mb-8">
            <h3 className="font-bold text-foreground mb-4">준비 중인 분석 서비스</h3>
            <ul className="space-y-3 text-sm text-muted-foreground">
              {["매출 트렌드 및 시즌 분석", "고객 방문 패턴 분석", "메뉴별 수익성 리포트", "배달 플랫폼 성과 분석", "경쟁사 벤치마킹 리포트"].map((item) => (
          ...
          <p className="text-sm text-muted-foreground mb-6">
            서비스 오픈 시 우선 안내를 받고 싶으시다면 문의해 주세요.
          </p>
          <Link
            to="/contact"
